...
<head>
  ...
  <title>FUM| Detail Kategori Produk</title>
...
?>
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Kategori Produk di Forum Usaha Mandiri Kota Cimahi
...
<a class="btn" href="kategori_produk.php"> Kembali</a>
...
$det=mysql_query("SELECT * FROM tb_cat_produk where id_cat_produk='$id_cat'")or die(mysql_error());
