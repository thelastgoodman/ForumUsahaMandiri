...
<div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <a href="data_topik_forum.php">  Kembali</a>
     <br><br>
<?php
$id_topik=mysql_real_escape_string($_GET['id']);
$det=mysql_query("select * from tb_forum_topik where id_topik='$id_topik'")or die(mysql_error());
while($d=mysql_fetch_array($det)){
	$tanggal=$d ['tanggal_topik'];
?>					
	<form  enctype= "multipart/form-data"  action="../ClassFUM/proses_forum.php?aksi=edittopikforum" method="post" name="daftar" id="myform">
		<table class="table">
		
				<input type="hidden" class="form-control" name="id" value="<?php echo $d['id_topik'] ?>">
				<input type="hidden" class="form-control" name="user" value="<?php echo $d['user_id'] ?>">
			</tr>
			<tr>
				<td>Judul Topik</td>
				<td><input type="text" class="form-control" name="judultopik" value="<?php echo $d['judul_topik'] ?>"></td>
			</tr>
			<tr>
				<td>Deskripsi</td>
				<td><input type="text" class="form-control" name="desk" value="<?php echo $d['isi_topik'] ?>"></td>
			</tr>
				<td></td>
