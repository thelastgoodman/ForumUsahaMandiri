...
header("content-disposition: attachment;filename=report_info_agenda.doc");
?>

<center><h2>Rekap Data Info Agenda</h2></center>
<table border='1'>
<h3>
<thead><tr>
...
<?php
$n=0;
$d = mysql_query("SELECT * FROM tb_agenda WHERE terlaksana='belum' ORDER BY id_agenda DESC ");
