...
<center><h2>Laporan Data Produk Forum Usaha Mandiri</h2></center>
<table border='1'>
<h3>
<thead><tr>
...
<td align="center" width=180>Klasifikasi Usaha</td>
...
<?php
$n=0;
$d = mysql_query("SELECT * FROM tb_info_produk INNER JOIN tb_cat_produk on tb_info_produk.id_cat_produk=tb_cat_produk.id_cat_produk INNER JOIN tb_anggota ON tb_info_produk.user_id=tb_anggota.user_id WHERE disetujui='Ya' ");
