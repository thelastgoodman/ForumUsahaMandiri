...
$id_agenda =mysql_real_escape_string($_GET['id']);
  ...
  $tanggal = $sql["tanggal_agenda"];
    echo "<i><p>Tanggal Post : ".date( "d-m-Y", strtotime($tanggal) )." | Dilihat : ".$sql['dibaca']." kali </p></i>";
    $tampil = $sql['gambar'];
      echo"<img src=\"../files/thumb_$tampil\" width=\"550\">";
      echo"<br><br>";
	  echo"<a class=\"btn btn-danger\" href=\"detail_topik_forum.php?option=view-topik&topik_id=".$_GET['topik_id']."\">Kembali</a>";
      echo "</div>";
