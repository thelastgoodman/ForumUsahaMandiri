...
<html>
	<head>
		<title> FK PEL | Data Produk  </title>
...
while($d=mysql_fetch_array($det)){
  ...
  echo "</div>";
	...
	$tanggal = $d["tanggal"];
	    ...
	    echo "<div class=\"panel-heading\"style='background:#f7f7f7; color:Gray;font-family:Helvetica; font-size:14px;' ><img src='assets2/images/bgpinggir.png' width=\"10px\" height=\"35px\"> &nbsp; No Telphone</div>";
	    echo"<span style=\"line-height:25px;font-family:Helvetica; font-size:13px; text-align:justify;\"><div class=\"panel-body\">".$d['no_telp']."</div></span>";
